...
/******/ 	return hotCreateRequire("./src/demo.js")(__webpack_require__.s = "./src/demo.js");
/******/ })
/************************************************************************/
/******/ ({
...
function convertFile(fileObject) {
  const fileName = fileObject.name.match(/(.*)\.[A-Z0-9]+|([^\.]+)$/i).slice(1).filter(function (v) {
    return !!v;
  }).shift();
...
function readFileCallback(umdConfig, fileContents) {
  try {
    _index__WEBPACK_IMPORTED_MODULE_0__["default"].resetAnimateVariables();
    const umd = new _index__WEBPACK_IMPORTED_MODULE_0__["default"](umdConfig).convert(fileContents);
    if (umd) {
      source.value = umd;
      Object(_utils__WEBPACK_IMPORTED_MODULE_1__["makeTemporaryComposition"])(umd);
      startCanvas();
    }
  } catch (e) {
