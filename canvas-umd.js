...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "97986e29ba4904fe01ec";
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CanvasUmd; });
...
(function (root, factory) {
	...
	var c = (${Object(_utils__WEBPACK_IMPORTED_MODULE_0__["enhancedCompositionGetter"])()})(${JSON.stringify(compId)});
	var l = c.getLibrary();
...
`;
  ...
  ingest(animateJS) {
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_0__["makeTemporaryComposition"])(animateJS);
    const comp = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["findOriginalComposition"])();
    const { properties: { id: compId } } = comp.getLibrary();
    const metadata = { compId, className };

    if (this.options['parse-labels']) {
      const instance = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["makeTemporaryInstance"])(comp, className);
  ...
  convert(animateJS) {
    ...
    return animateJS.replace(filterCjsRx, '$1$3').replace(footerRx, '') + footer;
  }
}
...
/*!**********************!*\
  !*** ./src/utils.js ***!
  \**********************/
/*! exports provided: findOriginalComposition, enhancedCompositionGetter, makeTemporaryComposition, makeTemporaryInstance */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "findOriginalComposition", function() { return findOriginalComposition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "enhancedCompositionGetter", function() { return enhancedCompositionGetter; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeTemporaryComposition", function() { return makeTemporaryComposition; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeTemporaryInstance", function() { return makeTemporaryInstance; });
function findOriginalComposition() {
  if (typeof AdobeAn === 'undefined' && lib) {
    /* Animate CC 2015.2 */
    const _lib = lib;
    return { getLibrary: function () {
        return _lib;
      } };
  } else if (AdobeAn) {
    if (Object.keys(AdobeAn).length === 0 && lib) {
      /* Animate CC 2017.1 */
      const _lib = lib;
      return { getLibrary: function () {
          return _lib;
...
function AnimateCC_2017_5_plus(compId) {
...
function enhancedCompositionGetter() {
  if (typeof AdobeAn === 'undefined' && lib) return AnimateCC_2015_2;else if (Object.keys(AdobeAn).length === 0 && lib) return AnimateCC_2017_1;else if (AdobeAn && AdobeAn.compositions) return AnimateCC_2017_5_plus;
}
 ...
 * @return void
 */
function makeTemporaryComposition(animateJS) {
 ...
 */
function makeTemporaryInstance(comp, className) {
  const lib = comp.getLibrary();
  if (className in lib) return new lib[className]();
...
//# sourceMappingURL=canvas-umd.js.map